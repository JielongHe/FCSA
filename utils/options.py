...
def get_args():
    ...
    parser.add_argument("--a", type=float, default=0.84)
    ...
    parser.add_argument("--i_mask", type=float, default=0.2)

    parser.add_argument("--i_mask_min", type=float, default=0.1)
    parser.add_argument("--i_mask_max", type=float, default=0.3)

    parser.add_argument("--t_mask", type=float, default=0.2)

    parser.add_argument("--lr_test", type=int, default=0)
